...
//import VirtuosoLogo from "../assets/images/VirtuosoLogo.png" -> // <img src={VirtuosoLogo}  alt=""   />
  ...
  return (
    ...
    <div className={"About"}>
       <div style={{margin: '15vh', flex: 2, maxWidth: '100%', border: '1px solid #cccccc', borderRadius: '10px', padding: '10px', maxHeight: '5000px', overflowY: 'auto', padding: '20px'}}> 
            ...
            <p className={styles.p} style ={{marginBottom: '30px', maxWidth: '90%'}}>see it for your self  ; )</p>
