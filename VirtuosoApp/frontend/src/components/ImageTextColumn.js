...
const TextColumn = ({ text, header, info}) => (
    <div style={{ flex: 2, maxWidth:'50%'}}>
        <div style={{ width: '100%', maxWidth: '100%', backgroundColor: 'beige', flex: 1, margin: '0 auto', borderRadius:'10px' }}>
...
const FlexibleColumns = () => {
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'stretch', margin: '0 60px' }}>
          <ImageColumn imageUrl={placeholderImage} />
          <div style={{ margin: '0 20px' }} /> {/* Add a spacer */}
