...
def send_confirmation_email(email, verification_url):
    ...
    text = f"Thanks for signing up! Please follow this link to activate your account:\n{verification_url}\nHave fun, and don't hesitate to contact us with your feedback.\nThe Team\nhttps://virtuosoreviews.com"
    html = f"<html><body><p>Thanks for signing up! Please follow this link to activate your account:</p><p><a href='{verification_url}'>{verification_url}</a></p><p>Have fun, and don't hesitate to contact us with your feedback.</p><p>The Team<br><a href='https://virtuosoreviews.com'>https://virtuosoreviews.com</a></p></body></html>"
